<template>
    <section class="mb-20">
        <h2
            class="text-3xl sm:text-4xl font-bold text-blue-400 mb-10 text-center relative pb-4
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4 lg:gap-5">
            <NuxtLink v-for="item in fivePreceptsItems" :key="item.key"
                ...
                class="bg-slate-800/70 backdrop-blur-md p-6 rounded-xl shadow-2xl border border-slate-700 hover:border-blue-500 transition-all duration-300 transform hover:scale-105 flex flex-col h-full">
                ...
                <p class="text-slate-300 leading-relaxed text-base flex-grow">
